...
<style>
   ...
   <div class="row" id="Recipes">
    <div class="col-md-12 container">
        <h2 style="padding:20px" class="text-center"><strong>Our Divinegreen Recipes</strong></h2>
        ...
        <div class="col-md-12  bg-white text-black" style="padding:20px">
            <div class="row">
                ...
                <div class="col-md-6 p-2">
                    ...
                    <iframe width="100%" height="315" src="{{ $recipe->link }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </iframe>
