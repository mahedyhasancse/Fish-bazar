    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title ">
                <h3 class="text-center bg-info text-white p-2  ">Car Parking Info</h3>
            </div>
            <hr>
            <form action="{{route('update.car',$car->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="category_name" name="name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{$car->name}}">
                    @error('title')
                ...
                <div class="form-group pl-2 pr-2">
                    ...
                    <textarea type="text" class="form-control" name="description" col="3" row="80">{!!$car->description!!}</textarea>
                    @error('description')
