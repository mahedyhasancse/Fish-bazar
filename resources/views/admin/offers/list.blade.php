                    ...
                    <form action="{{route('store.offer')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="offerPrice" name="offerPrice" type="number" step="0.01" class="form-control" aria-required="true"
                        ...
                        <div class="form-group">
                            ...
                            <div class='input-group date'>
                                <input class="form-control" type="date" id="validTill" name="validTill">
                            </div>
                        </div>
                        ...
                        <div>
                            <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                ...
                                <span id="payment-button-amount">Add offer</span>
                            </button>
                        </div>
                    </form>
                </div>
